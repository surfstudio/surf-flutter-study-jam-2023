...
class TicketUrlField extends StatefulWidget {
  final TicketModel ticket;
  final ValueChanged<String> onUrlChanged;

  const TicketUrlField({
    super.key,
  ...
  @override
  State<TicketUrlField> createState() => _TicketUrlFieldState();
}

class _TicketUrlFieldState extends State<TicketUrlField> {
